...
{title:'Quel espace Squared utiliser ?',desc:'Choisir entre Squared Group, Workspace, Help Center et Build selon son besoin.',href:'ecosystem.html',type:'Guide',icon:'SG',tags:'orientation ecosysteme squared workspace help center build'},
{title:'Préparer le démarrage de votre projet',desc:'Réunir les informations et ressources utiles avant le démarrage d’un projet client.',href:'client-project-start.html',type:'Guide',icon:'PRJ',tags:'client projet demarrage contenus fichiers brief'},
{title:'Faire un retour sur une proposition',desc:'Formuler un feedback client précis et exploitable.',href:'client-feedback.html',type:'Guide',icon:'COM',tags:'client feedback validation retour revision'},
{title:'Comprendre une mission avant de commencer',desc:'Vérifier résultat attendu, périmètre, ressources et validation.',href:'collaborator-mission-start.html',type:'Guide',icon:'OP',tags:'collaborateur mission brief perimetre'},
{title:'Signaler un blocage ou un retard',desc:'Prévenir avec le contexte nécessaire pour permettre une décision.',href:'collaborator-blocker.html',type:'Guide',icon:'FIX',tags:'collaborateur blocage retard aide'},
{title:'Remettre un travail pour validation',desc:'Préparer et présenter un résultat vérifiable.',href:'collaborator-submit.html',type:'Guide',icon:'PUB',tags:'collaborateur remise validation livraison'},
{title:'Suivre une demande privée',desc:'Compléter un ticket existant sans disperser les informations.',href:'support-follow-up.html',type:'Support',icon:'SUP',tags:'support ticket suivi demande privee'},
...
{title:'Workspace — Activation & accès',desc:'Invitation, activation et premier accès.',href:'workspace/workspace-activation.html',type:'Produit',icon:'ACL',tags:'workspace activation invitation accès'},
{title:'Workspace — Installation',desc:'Installation iOS, iPadOS, macOS et versions de test.',href:'workspace/workspace-installation.html',type:'Produit',icon:'PUB',tags:'workspace installation testflight ios macos'},
{title:'Workspace — Compte & profil',desc:'Identité, préférences et sécurité du membre.',href:'workspace/workspace-account.html',type:'Produit',icon:'ME',tags:'workspace compte profil préférences'},
{title:'Workspace — Membres & organisations',desc:'Membre, organisation, rôle et permissions.',href:'workspace/workspace-members.html',type:'Produit',icon:'ACL',tags:'workspace membres organisation permissions'},
{title:'Workspace — Clients',desc:'Expérience client et limites de visibilité.',href:'workspace/workspace-clients.html',type:'Produit',icon:'COM',tags:'workspace client espace client livrables'},
{title:'Workspace — Collaborateurs',desc:'Accès collaborateurs, missions et ressources.',href:'workspace/workspace-collaborators.html',type:'Produit',icon:'ME',tags:'workspace collaborateur équipe missions'},
{title:'Workspace — Pôles & structure',desc:'Structurer les responsabilités et les risques.',href:'workspace/workspace-departments.html',type:'Produit',icon:'NAV',tags:'workspace pôles structure organisation'},
{title:'Workspace — Missions',desc:'Niveau de responsabilité entre projet et tâches.',href:'workspace/workspace-missions.html',type:'Produit',icon:'OP',tags:'workspace missions projet responsabilité'},
{title:'Workspace — Tâches',desc:'Actions exécutables, responsables et statuts.',href:'workspace/workspace-tasks.html',type:'Produit',icon:'QG',tags:'workspace tâches statuts exécution'},
{title:'Workspace — Planning',desc:'Échéances, jalons et coordination.',href:'workspace/workspace-planning.html',type:'Produit',icon:'NEW',tags:'workspace planning échéances jalons'},
{title:'Workspace — Messages',desc:'Conserver les échanges dans leur contexte.',href:'workspace/workspace-messages.html',type:'Produit',icon:'COM',tags:'workspace messages collaboration mentions'},
{title:'Workspace — Notifications',desc:'Signaux utiles, mentions et réduction du bruit.',href:'workspace/workspace-notifications.html',type:'Produit',icon:'NTF',tags:'workspace notifications alertes mentions'},
{title:'Workspace — Contrats',desc:'Traçabilité, accès et version contractuelle.',href:'workspace/workspace-contracts.html',type:'Produit',icon:'SEC',tags:'workspace contrats documents confidentiel'},
{title:'Workspace — Invitations',desc:'Créer, suivre et sécuriser les invitations.',href:'workspace/workspace-invitations.html',type:'Produit',icon:'ACL',tags:'workspace invitations clients collaborateurs'},
{title:'Workspace — Raccourcis clavier',desc:'Accélérer les actions fréquentes.',href:'workspace/workspace-shortcuts.html',type:'Produit',icon:'QG',tags:'workspace raccourcis clavier productivité'},
{title:'Workspace — Recherche & command palette',desc:'Retrouver les objets accessibles et lancer des actions.',href:'workspace/workspace-search.html',type:'Produit',icon:'SEO',tags:'workspace recherche command palette productivité'},
